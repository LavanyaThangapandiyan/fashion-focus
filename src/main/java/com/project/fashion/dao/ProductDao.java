...
Validation valid=new Validation();
	...
	{	
		String update="update product set name=?,price=?,type=?,size=?,quantity=?,fabric=?,gender=? where id=?";
	...
	{
		String find="select name,price,type,size,fabric,gender,image from product";
	...
	{
		String find="select name,price,type,size,quantity,fabric,gender,image from product";
